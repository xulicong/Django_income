...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$120000$323pLObAGUCH$fBbPM4q9B/fauxdM9wdqCfnnThBGPEnMtQ6u8wRiW1Y=','2020-05-04 13:06:54.695365',1,'admin','','','401719568@qq.com',1,1,'2019-05-05 02:53:05.310948'),(2,'pbkdf2_sha256$120000$W1Fei95xXEdx$QXH7R4wc8nDfZH53hQbB2n7KN1Yg3XUny6EKb/a3d9I=','2020-05-01 09:29:29.050697',0,'Lison','立聪','许','401719568@qq.com',1,1,'2019-05-12 08:07:00.000000'),(3,'pbkdf2_sha256$150000$hWQsZzpKicse$fBuQ+9VyKfH4hKiOgcuxSojEoe09i4Tr8s8Npfm9pFk=','2019-06-15 09:00:40.289059',0,'Aloe','茹会','王','',1,1,'2019-05-12 08:08:00.000000');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(4,'auth','permission'),(2,'auth','user'),(5,'contenttypes','contenttype'),(9,'piggy_bank','debtsdb'),(10,'piggy_bank','fundpooldb'),(8,'piggy_bank','incomdb'),(7,'piggy_bank','yeardb'),(6,'sessions','session');
...
--
-- Table structure for table `piggy_bank_fundpooldb`
--

DROP TABLE IF EXISTS `piggy_bank_fundpooldb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `piggy_bank_fundpooldb` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `monthly` varchar(20) DEFAULT NULL,
  `cash_pool` decimal(10,2) NOT NULL,
  `insurance_pool` decimal(10,2) NOT NULL,
  `goal_pool` decimal(10,2) NOT NULL,
  `invest_pool` decimal(10,2) NOT NULL,
  `invest_income` decimal(10,2) NOT NULL,
  `create_time` datetime(6) NOT NULL,
  `Year_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `piggy_bank_fundpooldb_Year_id_79a86fcf_fk_piggy_bank_yeardb_id` (`Year_id`),
  CONSTRAINT `piggy_bank_fundpooldb_Year_id_79a86fcf_fk_piggy_bank_yeardb_id` FOREIGN KEY (`Year_id`) REFERENCES `piggy_bank_yeardb` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `piggy_bank_fundpooldb`
--

LOCK TABLES `piggy_bank_fundpooldb` WRITE;
/*!40000 ALTER TABLE `piggy_bank_fundpooldb` DISABLE KEYS */;
INSERT INTO `piggy_bank_fundpooldb` VALUES (2,'5月',17694.91,42.84,5036.40,13547.56,-859.18,'2020-05-04 13:17:43.074752',2);
/*!40000 ALTER TABLE `piggy_bank_fundpooldb` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-05-05  0:14:32
